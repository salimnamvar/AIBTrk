...
Classes:
    - `Size`: The `Size` class represents the dimensions (width and height) of an object.
...
from brain.util import BaseObject, is_int, is_float
...
class Size(BaseObject):
    ...
    def __init__(self, a_width: Union[int, float], a_height: Union[int, float], a_name: str = "SIZE"):
    ...
    def __lt__(self, a_size: "Size") -> bool:
        """
    ...
    def __le__(self, a_size: "Size") -> bool:
        """
        Compares the size with another Size object.
    ...
    def __eq__(self, a_size: "Size") -> bool:
        """
    ...
    def __ge__(self, a_size: "Size") -> bool:
        """
        Compares the size with another Size object.
    ...
    def __gt__(self, a_size: "Size") -> bool:
        """
        Compares the size with another Size object.
